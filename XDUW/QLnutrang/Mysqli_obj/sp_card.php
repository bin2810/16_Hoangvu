...
<body>
    ...
    <?php
        ...
        $sql_count = "SELECT * FROM tbsanpham";
        $result_count = $conn->query($sql_count);
        $row = $result_count->fetch_all();
        $tong_sp = count($row);
            ...
            <form action="giohang.php?action=add" method="post">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pad"><input type="number" min="1" name="th_SoLuong[<?=$sp['SanPham_id']?>]" id="th_soluong" value="1" size="2"></div>
                        <div class="card-text">
